...
INSTANTIATE_TEST_SUITE_P(BaseAdvancedMonoCart8ObjectWithLoudness3_1_2,
                         TestVector, testing::Values("test_000802.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedPolarObjects, TestVector,
                         testing::Values("test_000803.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedCart8Objects, TestVector,
                         testing::Values("test_000804.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedCart16Objects, TestVector,
                         testing::Values("test_000805.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedDualPolarObject, TestVector,
                         testing::Values("test_000806.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedDualCart8Object, TestVector,
                         testing::Values("test_000807.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedDualCart16Object, TestVector,
                         testing::Values("test_000808.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedDualPolarObjectMultipleAudioElements,
                         TestVector, testing::Values("test_000809.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedDualCart8ObjectMultipleAudioElements,
                         TestVector, testing::Values("test_000810.textproto"));
...
INSTANTIATE_TEST_SUITE_P(BaseAdvancedMonoPolarAndMonoCart8Object, TestVector,
                         testing::Values("test_000812.textproto"));
...
INSTANTIATE_TEST_SUITE_P(BaseAdvancedMonoCart16AndDualCart8Object, TestVector,
                         testing::Values("test_000825.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedMonoCart16AndDualCart16Object, TestVector,
                         testing::Values("test_000826.textproto"));
...
INSTANTIATE_TEST_SUITE_P(BaseAdvanced7_1_5_4ChAndStereo, TestVector,
                         testing::Values("test_000833.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedLfePairAnd3_1_2, TestVector,
                         testing::Values("test_000834.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedBottom3chAnd5_1, TestVector,
                         testing::Values("test_000835.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedBottom4chAnd5_1_2, TestVector,
                         testing::Values("test_000836.textproto"));

INSTANTIATE_TEST_SUITE_P(BaseAdvancedTop1chAnd9_1_6, TestVector,
                         testing::Values("test_000837.textproto"));
...
INSTANTIATE_TEST_SUITE_P(Advanced1Stereo_AndFourObjects, TestVector,
                         testing::Values("test_000901.textproto"));

INSTANTIATE_TEST_SUITE_P(Advanced13_1_2_AndFourObjects, TestVector,
                         testing::Values("test_000902.textproto"));

INSTANTIATE_TEST_SUITE_P(Advanced15_1_AndFourObjects, TestVector,
                         testing::Values("test_000903.textproto"));

INSTANTIATE_TEST_SUITE_P(Advanced15_1_2_AndFourObjects, TestVector,
                         testing::Values("test_000904.textproto"));

INSTANTIATE_TEST_SUITE_P(Advanced15_1_4_AndFourObjects, TestVector,
                         testing::Values("test_000905.textproto"));
...
INSTANTIATE_TEST_SUITE_P(Advanced1LFE_AndTwoDualPolarObjects, TestVector,
                         testing::Values("test_000912.textproto"));

INSTANTIATE_TEST_SUITE_P(Advanced1StereoS_AndTwoDualPolarObjects, TestVector,
                         testing::Values("test_000913.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced1StereoSS_AndOneDualPolarAndTwoMonoPolarObjects, TestVector,
    testing::Values("test_000914.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced1StereoRS_AndOneDualPolarAndTwoMonoPolarObjects, TestVector,
    testing::Values("test_000915.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced1StereoTF_AndOneDualPolarAndTwoMonoPolarObjects, TestVector,
    testing::Values("test_000916.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced1StereoTB_AndOneDualPolarAndTwoMonoPolarObjects, TestVector,
    testing::Values("test_000917.textproto"));

INSTANTIATE_TEST_SUITE_P(Advanced1StereoF_AndOneDualPolarAndTwoMonoPolarObjects,
                         TestVector, testing::Values("test_000918.textproto"));
...
INSTANTIATE_TEST_SUITE_P(
    Advanced1_TpSiAndZerothOrderAmbisonicsAndFourMonoPolarObjects, TestVector,
    testing::Values("test_000924.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced1_LFEPairAndZerothOrderAmbisonicsAndFourMonoPolarObjects,
    TestVector, testing::Values("test_000925.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced1_Bottom3ChAndZerothOrderAmbisonicsAndFourMonoPolarObjects,
    TestVector, testing::Values("test_000926.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced1_Bottom4ChAndFirstOrderAmbisonicsAndFourMonoPolarObjects,
    TestVector, testing::Values("test_000927.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced1_Top1ChAndFirstOrderAmbisonicsAndTwoDualPolarObjects, TestVector,
    testing::Values("test_000928.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced1_Top5ChAndFirstOrderAmbisonicsAndTwoDualPolarObjects, TestVector,
    testing::Values("test_000929.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced1_StereoAnd2OAAndTwoDualPolarObjectsAndLoudspeakerLoudness,
    TestVector, testing::Values("test_000930.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced1_StereoAnd2OAAndTwoDualPolarObjectsAndBinauralLoudness, TestVector,
    testing::Values("test_000931.textproto"));
...
INSTANTIATE_TEST_SUITE_P(Advanced2_9_1_6_ZerothOrderAmbisonicsAndMonoObjects,
                         TestVector, testing::Values("test_001007.textproto"));

INSTANTIATE_TEST_SUITE_P(Advanced2_7_1_5_4_FirstOrderAmbisonicsAndMonoObjects,
                         TestVector, testing::Values("test_001008.textproto"));

INSTANTIATE_TEST_SUITE_P(Advanced2_7_1_4_SecondOrderAmbisonicsAndMonoObjects,
                         TestVector, testing::Values("test_001009.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced2StereoThirdOrderAmbisonicsDualObjectsAnd7_1_5_4Layout, TestVector,
    testing::Values("test_001010.textproto"));

INSTANTIATE_TEST_SUITE_P(
    Advanced2StereoThirdOrderAmbisonicsDualObjectsAnd10_2_9_3Layout, TestVector,
    testing::Values("test_001011.textproto"));
