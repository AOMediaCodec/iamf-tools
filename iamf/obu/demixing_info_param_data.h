 ...
 */
#ifndef OBU_DEMIXING_INFO_PARAM_DATA_H_
#define OBU_DEMIXING_INFO_PARAM_DATA_H_
...
struct DownMixingParams {
  friend bool operator==(const DownMixingParams& left,
                         const DownMixingParams& right) = default;
...
#endif  // OBU_DEMIXING_INFO_PARAM_DATA_H_
