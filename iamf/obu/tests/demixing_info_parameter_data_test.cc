...
TEST(CreateDemixingInfoParameterData, ReadDMixPMode1) {
  std::vector<uint8_t> source_data = {kDMixPMode1 << kDMixPModeBitShift};
  auto rb = MemoryBasedReadBitBuffer::CreateFromSpan(
      absl::MakeConstSpan(source_data));

  auto data = DemixingInfoParameterData::CreateFromBuffer(*rb);
...
TEST(CreateDemixingInfoParameterData, ReadDMixPMode3) {
  std::vector<uint8_t> source_data = {kDMixPMode3 << kDMixPModeBitShift};
  auto rb = MemoryBasedReadBitBuffer::CreateFromSpan(
      absl::MakeConstSpan(source_data));
...
TEST(CreateDemixingInfoParameterData, ReadReservedMax) {
  const uint32_t kReservedMax = 31;
  std::vector<uint8_t> source_data = {kDMixPMode1 << kDMixPModeBitShift |
                                      kReservedMax};
  auto rb = MemoryBasedReadBitBuffer::CreateFromSpan(
...
TEST(CreateDemixingInfoParameterData, IllegalReadDMixPModeReserved) {
  constexpr auto kReservedDMixPMode = kDMixPModeReserved1;
  std::vector<uint8_t> source_data = {kReservedDMixPMode << kDMixPModeBitShift};
  auto rb = MemoryBasedReadBitBuffer::CreateFromSpan(
      absl::MakeConstSpan(source_data));
...
TEST(CreateDefaultDemixingInfoParameterData, ReadSuccess) {
  constexpr auto kExpectedDMixPMode = kDMixPMode1_n;
  constexpr auto kExpectedReserved = 25;
  constexpr auto kExpectedDefaultW = 9;
  constexpr auto kExpectedReservedDefault = 12;
  ...
  auto data = DefaultDemixingInfoParameterData::CreateFromBuffer(*rb);
...
TEST(CreateDefaultDemixingInfoParameterData, IllegalReadDMixPModeReserved) {
  constexpr auto kReservedDMixPMode = kDMixPModeReserved1;
  constexpr auto kExpectedReserved = 25;
  constexpr auto kExpectedDefaultW = 9;
  constexpr auto kExpectedReservedDefault = 12;
  std::vector<uint8_t> source_data = {
      kReservedDMixPMode << kDMixPModeBitShift | kExpectedReserved,
      kExpectedDefaultW << kDefaultWBitShift | kExpectedReservedDefault};
  auto rb = MemoryBasedReadBitBuffer::CreateFromSpan(
      absl::MakeConstSpan(source_data));
